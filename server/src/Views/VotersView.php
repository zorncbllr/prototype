...
<head>
    ...
    <script defer src="js/lib/htmx.js"></script>
</head>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500  ">
            ...
            <tbody id="table-body">
                <?php foreach ($voters as $voter): ?>
                    <tr class="border-b  border-gray-200 <?= $voter->isGiven ? "bg-blue-100" : "bg-white " ?>>">
                        ...
                        <td class="px-6 py-4 text-right">
                            <button
                                hx-patch="/voters/<?= $voter->voterId ?>"
                                hx-trigger="click"
                                hx-swap="innerHTML"
                                hx-target="#table-body"
                                class="font-medium text-blue-600 hover:underline marker">Mark</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
